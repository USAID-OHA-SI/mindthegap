...
The package has a built in function, `base_plot`, to generate this as a datatable for you.
...
```{r}
v_plhiv <- base_plot(df_unaids, "Namibia", denom = "PLHIV", grp = "All")
v_plhiv
```
...
```{r}
v_relative <- base_plot(df_unaids, "Namibia", denom = "Relative", grp = "All")
v_relative
```
