...
```
The `epi_plot` function allows for you to list several countries of interest in the `sel_cntry` parameter, in case you want to compare epidemic control across countries. 
