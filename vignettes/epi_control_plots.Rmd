...
```{r, message = FALSE, warning=FALSE, fig.align="center"}
plot_connected_scatter(df_unaids, sel_cntry = "Zambia") + ggplot2::labs(title = toupper("Zambia reached epidemic control in 2023"))
```
...
```{r, message = FALSE, warning=FALSE, fig.align="center"}
plot_connected_scatter(df_unaids, sel_cntry = c("Malawi", "Mozambique", "Tanzania")) + ggplot2::labs(title = toupper("Zambia reached epidemic control in 2023"))
```
...
```{r, message = FALSE, warning=FALSE, fig.align="center"}
  ...
  combined_plot <- patchwork::wrap_plots(plots, ncol = 2) + ggplot2::labs(caption = mindthegap::source_note)
