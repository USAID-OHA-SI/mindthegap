...
munge_unaids <- function(return_type, indicator_type) {
  ...
  gdrive_df_clean <- gdrive_df_clean %>%
    dplyr::mutate(indicator = dplyr::recode(indicator,
                                            ...
                                            "plhivOnArt" = "Percent PLHIV On ART",
                                            "knownstatusOnArt" = "Percent Known Status On ART",
                                            "plhivVLS" = "Percent PLHIV with VLS",
                                            "onArtVLS" = "Percent on ART with VLS",
                                            "knownstatusNum" = "Number Known Status of PLHIV",
                                            "onArtNum" = "Number PLHIV On ART",
                                            "vlsNum" = "Number PLHIV with VLS",
